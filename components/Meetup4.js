      ...
      <SafeAreaView>
        <View style={styles.flexWrapper}>
          <View>
              ...
              <Text style={styles.label}>About Carla: </Text>

              <View style={styles.bioContainer} >
                <Text style={styles.bioText}>
                  Hi my name is Carla. I love Chick-fil-a and I'm excited to meet new friends.
