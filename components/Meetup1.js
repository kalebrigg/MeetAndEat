        ...
        <View style={styles.flexWrapper}>
          <View>
              ...
              <Text style={styles.secondaryText}>
                {'Wants to eat at Five Guys!\n21   -   Female'}
              </Text>

              <Text style={styles.label}>About Gabriella: </Text>

              <View style={styles.bioContainer} >
                <Text style={styles.bioText}>
                  Hi my name is Gabriella. I love Five Guys and I'm excited to meet new friends.
