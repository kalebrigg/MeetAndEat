        ...
        <View>
          ...
          <ScrollView style={styles.requestContainer}
            ...
            <View style={styles.requestItem}>
              ...
              <Text style={styles.place}>Meet at Pizza Hut</Text>
            ...
            <View style={styles.requestItem}>
              ...
              <Text style={styles.place}>Meet at Black Bear Diner</Text>
            ...
            <View style={styles.requestItem}>
              ...
              <Text style={styles.place}>Meet at Five Guys</Text>
              <Text style={styles.info}>21 - Female</Text>
            ...
            <View style={styles.requestItem}>
              ...
              <Text style={styles.place}>Meet at Raising Canes</Text>
              <Text style={styles.info}>23 - Male</Text>
              <Text style={styles.contact}>Snapchat: jamesjohn</Text>
            </View>
            ...
            <View style={styles.requestItem}>
              ...
              <Text style={styles.place}>Meet at Subway</Text>
            ...
            <View style={styles.requestItem}>
              ...
              <Text style={styles.place}>Meet at Wendys</Text>
